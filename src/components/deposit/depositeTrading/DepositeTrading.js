...
import { getDepositTradingData } from '../../../api/login/Login';
import Loader from '../../../common/loader/Loader';

function DepositeTrading() {
  ...
  const getTransitionReport = async (input) => {
    ...
    try {
      const res = await getDepositTradingData(clone)
      // console.log(res);
  ...
  return (
    <>
      ...
      <div className="PageHeading">
        <h1>Deposit Trading</h1>
      </div>
      <div className="ContentArea">
        <div className="card">
          <div className="card-header"><span>Fillter Deposit Trading</span>
          </div>
...
export default DepositeTrading
