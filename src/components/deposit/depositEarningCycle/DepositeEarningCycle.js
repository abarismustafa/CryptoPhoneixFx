...
import { getDepositearningCycleData } from '../../../api/login/Login';
import Loader from '../../../common/loader/Loader';

function DepositeEarningCycle() {
    ...
    const getTransitionReport = async (input) => {
        ...
        try {
            const res = await getDepositearningCycleData(clone)
            // console.log(res);
    ...
    return (
        <>
            ...
            <div className="PageHeading">
                <h1>Deposit Earning Cycle</h1>
            </div>
            <div className="ContentArea">
                <div className="card">
                    <div className="card-header"><span>Fillter Deposit Earning Cycle</span>
                    </div>
                    <div className="card-body">
                        <form action="" method="post" name="frmReport" id="frmReport">
                            <div className="form-row" >
                                ...
                                <div className="form-group col-lg-4 col-md-12  mt-4">
                                    <label>&nbsp;</label>
...
export default DepositeEarningCycle
