...
function MerchantResetPassword({ getOtp, resetOtp, OtpUp, openReset, handleChange, initalValue, userId, setOtpUp, setOpenReset, setLoginForm, setInitialValue, buttonDisable, mobileMsg, setButtonDisable, setMobileMsg, panError, mobileError, emailError,
            ...
            <>
                {resetOtp ? <div className="mobile-login-phone">
                    <form action="" >
                        ...
                        <div>
                            <button
                                ...
                                className={`commonButton ${radioSet ? (!initalValue.emailId || !isValidPAN(initalValue.pan) ? 'commonButton not-allowed' : 'commonButton') : (!isValidMobile(initalValue.mobileNo) || !isValidPAN(initalValue.pan) ? 'disableebuttoncls not-allowed' : 'btn-login')}`}
                    ...
                    <div className="text-align-center mt-2">
                        <div onClick={() => setLoginForm(true)} style={{ cursor: 'pointer' }}>Back To Sign In</div>
                    </div>
                </div> : <></>}
            </>
                ...
                <div className="mobile-login-phone">
                    <form action="">
                        ...
                        <div className="input-group mb-2">
                            ...
                            <input
                                type="password"
                                className={`form-control ${resetInitialValue?.repassword && (resetInitialValue?.password === resetInitialValue?.repassword)
                                        ? 'is-valid'
                        ...
                        <div>
                            <button
                                ...
                                className={`commonButton ${!isValid || resetInitialValue?.password !== resetInitialValue?.repassword
                                        ? ''
                                        : 'commonButton'
                                    }`}
                    ...
                    <div className="text-align-center mt-1">
                        <div onClick={() => setLoginForm(false)} style={{ cursor: 'pointer' }}>
                            Back To Sign In
                        </div>
                    </div>
                </div>
