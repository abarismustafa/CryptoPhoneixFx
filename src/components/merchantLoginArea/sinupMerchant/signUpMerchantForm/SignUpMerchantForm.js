...
function SignUpMerchantForm({
  ...
  const [sucessData, setSuccesData] = useState(false)
  ...
  const extractedPosition = param?.id?.split("=")[1].toLowerCase() || "left";
  ...
  const [resiter, setResister] = useState({
    ...
    password: "",
    repassword: "",
    currency_id: "67cc033dd39b755607649af5",
    position: "",
    sponsor_id: "",
    refer_id: "",
  });
  ...
  const referOnchange = (e) => {
    ...
    if (name === "refer_id" && value.length >= 5) {
      getRefer(clone);
    }
  };
  ...
  const handleSubmit = async (event) => {
    ...
    const cloen = {
      ...
      email: emailUser,
      state: selectedState,
      position: referDataInitial?.position,
      refer_id: referDataInitial?.refer_id,
    };
  ...
  useEffect(() => {
    setResister((prev) => ({
      ...
      repassword: initalValue.mobileNo.slice(3, 13),
    }));
            ...
            <div className="row">
              ...
              <div className="col-xl-6">
                ...
                <div className="input-group mb-3 input-group-set-mob">
                  ...
                  <div className="input-group-text p-0 country-select-wrapper">
                    <select
                      className="form-select form-select-sm border-0 country-select"
              ...
              {/* <div className="col-lg-4   mb-3">
                ...
                <select
                  ...
                  aria-label="Default select example"
                  name="position"
                  value={referDataInitial.position}
              ...
              <div className="col-lg-4 mb-1">
                ...
                <div className="input-group mb-1">
                  ...
                  <input
                    type="text"
                    className="form-control"
                    placeholder="Enter Your I have a referral code!"
                    name="refer_id"
                    value={referDataInitial.refer_id}
                    onChange={referOnchange}
                  />
                </div>
                {/* <p style={{ color: "red", marginBottom: '2px' }}>{errorValue.refer_id}</p> */}
              ...
              {selectedUserType !== "Super Distributor" && (
                <>
                  <div className="col-lg-6 mb-3">
                    <label htmlFor="refer_id">Without Refer ID</label>
                    <div
        ...
        >
          ...
          >
            <div className="para-comor">
              <p>
                Thank you for your interest in PayPanda payment solutions. Our
                enterprise team will contact you shortly.
              </p>
              <p>
                If you have any further questions, feel free to contact us at{" "}
                <a href="mailto:support@paypanda.in" target="blank">
                  support@paypanda.in
                </a>{" "}
                or call us toll-free at{" "}
                <a href="tel:+9118008890178" target="blank">
                  18008890178
                </a>{" "}
                .
              </p>
