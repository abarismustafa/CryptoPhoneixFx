...
function Liveincome() {
  ...
  const [callFirst, setCallFirst] = useState(true)
  ...
  const getTransitionReport = async (input) => {
    // console.log('iojijip');
    setLoading(true)
    const clone = callFirst 
    ?{ count: count, page: input, user_id: window.localStorage.getItem('userIdToken') }:{ ...filterInitial, count: count, page: input, user_id: window.localStorage.getItem('userIdToken') }
    try {
