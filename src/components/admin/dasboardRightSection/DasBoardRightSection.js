...
function DasRightSectionPage({ tokenNoti, walletData, services, handleLogout }) {
    ...
    return (
        <>
            ...
            <div className="LayoutMain" ref={ref} id="abcd dadas" >
                <AdminHeader walletData={walletData} toggleSidebar2={toggleSidebar2} handleClick={handleClick} toggleSidebar={toggleSidebar} profileOn={profileOn} profileOf={profileOf} toggle={toggle} tokenNoti={tokenNoti} handleLogout={handleLogout} />
