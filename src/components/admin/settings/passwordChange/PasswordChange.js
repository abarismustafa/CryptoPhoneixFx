...
function PasswordChange() {
  ...
  const handleChange = (e, str) => {
    ...
    if (str == "newPassword") {
      const regex =
        /^(?=.*[a-zA-Z])(?=.*\d)(?=.*[@$!&])[A-Z](?=.*[a-zA-Z\d@$!&])[a-zA-Z\d@$!&]{8,}$/;
          ...
          <div className="card-body">
            ...
            >
              <div className="form-row">
                ...
                <div className="form-group input-group-eye input-group-eye-2 col-lg-4 col-md-12">
                  ...
                  {initialData.newPassword &&
                    (isValid ? (
                      ...
                      <p style={{ color: "red", marginBottom: "4px" }}>
                        {" "}
                        Password: 8+ chars, start with a capital, include a
                        special char, alphanumeric.
                      </p>
                    ))}
                </div>
                <div className="form-group col-lg-4 col-md-12  input-group-eye input-group-eye-2">
                  <label htmlFor="txtCnfPassword">
                  ...
                  <input
                    ...
                    onChange={handleChange}
                  />
                  <div className="eye" onClick={toggleShowPassword2}>
                    {showPassword2 ? <IoMdEye /> : <FaEyeSlash />}{" "}
                  </div>
                </div>
              </div>
