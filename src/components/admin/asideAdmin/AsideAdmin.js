                    ...
                    <div className="MenuItem ">
                        ...
                        <div id="collapseSettings" className={`SubmenuItems collapse ${allAside.profile ? "mm-show" : "extra"}`} aria-labelledby="headingSettings" data-parent="#accordion">
                            <ul>
                                ...
                                <li onClick={handleMenuClick}>
                                    <NavLink to="my_kyc">My KYC</NavLink>
                                </li>
                                {/* <li onClick={handleMenuClick}>
                    ...
                    <div className="MenuItem ">
                        ...
                        <div id="collapseSettings" className={`SubmenuItems collapse ${allAside.income ? "mm-show" : "extra"}`} aria-labelledby="headingSettings" data-parent="#accordion">
                            <ul>
                                ...
                                <li onClick={handleMenuClick}>
                                    <NavLink to="achievement-activated">Achivement Activate</NavLink>
                                </li>
                                <li onClick={handleMenuClick}>
                            ...
                            <div className="MenuItem ">
                                ...
                                <div id="collapseOne" className={`SubmenuItems collapse ${allAside.report ? "mm-show" : "extra"}`} >
                                    <ul>
                                        ...
                                        <li onClick={handleMenuClick}>
                                            <NavLink to="deposit-report">Deposit Report</NavLink>
                                        </li>
                                        <li onClick={handleMenuClick}>
                                            <NavLink to="deposit-invesment-report">Deposit Invesment Report</NavLink>
                                        </li>
                    ...
                    <div className="MenuItem ">
                        ...
                        <div id="collapseSettings" className={`SubmenuItems collapse ${allAside.deposit ? "mm-show" : "extra"}`} aria-labelledby="headingSettings" data-parent="#accordion">
                            <ul>
                                ...
                                <li onClick={handleMenuClick}>
                                    <NavLink to="deposit-INR-Staking">Deposit USD (Staking)</NavLink>
                                </li>
                                <li onClick={handleMenuClick}>
                                    <NavLink to="deposit-trading">Deposit Trading</NavLink>
                                </li>
                                <li onClick={handleMenuClick}>
                                    <NavLink to="deposit-earning-cycle">Deposit Earning Cycle</NavLink>
                                </li>
                            </ul>
                        </div>
                    </div>
