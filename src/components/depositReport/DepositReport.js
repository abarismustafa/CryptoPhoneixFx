...
import { depositReportGet } from '../../api/login/Login';
...
const DepositReport = () => {
    ...
    const getTransitionReport = async (input) => {
        ...
        try {
            const res = await depositReportGet(clone)
            // console.log(res);
                            ...
                            <table className="table table-striped table-bordered table-hover display dataTable no-footer dtr-inline collapsed" id="myTable" role="grid" aria-describedby="myTable_info" >
                                <thead>
                                    <tr role="row">
                                        ...
                                        <th className="sorting" >Deposit Name</th>
                                        <th className="sorting" >UTR No</th>
                                        <th className="sorting" >Payment Mode</th>
                                        <th className="sorting" >Payment Deposit Date</th>
                                        {/* <th className="sorting" >Is Commission</th> */}
                                        <th className="sorting" >Reciept</th>
                                ...
                                <tbody>
                                    {data && data?.map((item, i) => {
                                        ...
                                        return <tr className="odd" key={item?._id}>
                                            ...
                                            <td valign="top" className="dataTables_empty">{item?.bank_holder_name}</td>
                                            ...
                                            <td valign="top" className="dataTables_empty">{item?.deposit_id?.name}</td>

                                            <td valign="top" className="dataTables_empty">{item?.utr_no}</td>
                                            <td valign="top" className="dataTables_empty">{item?.payment_mode}</td>

                                            <td valign="top" className="dataTables_empty">{item?.payment_deposit_date}</td>
