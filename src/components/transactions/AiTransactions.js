...
import { getmlm_tpin_transferRepot } from "../../api/login/Login";
// Pin Transfer Report
export default function AiTransactions() {
    ...
    const getTransitionReport = async (input) => {
        ...
        try {
            const res = await getmlm_tpin_transferRepot(clone)
            // console.log(res);
                            ...
                            <table className="table table-striped table-bordered table-hover display dataTable no-footer dtr-inline collapsed" id="myTable" role="grid" aria-describedby="myTable_info" >
                                <thead>
                                    <tr role="row">
                                        ...
                                        <th className="sorting" >from Member Code </th>
                                        <th className="sorting" >from Member Name</th>
                                        <th className="sorting" >To Member Code</th>
                                        <th className="sorting" >To Member Name</th>
                                    ...
                                    {data && data?.map((item, i) => {
                                        ...
                                        return <tr className="odd" key={item?._id}>
                                            ...
                                            <th valign="top" className="dataTables_empty">
                                                {item?.pin_id?.plan_id?.name}
                                            </th>
                                            <td valign="top" className="dataTables_empty">{item?.transferBy}</td>
                                            <td valign="top" className="dataTables_empty"></td>
                                            <td valign="top" className="dataTables_empty"></td>
                                            <td valign="top" className="dataTables_empty">{item?.transfer_to_member?.refer_id}</td>
                                            <td valign="top" className="dataTables_empty">{item?.transfer_to_member?.name}</td>
